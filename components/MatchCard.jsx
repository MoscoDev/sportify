...
export default function MatchCard({matches, week}) {
  ...
  // }, []);
      ...
      return (
        ...
        >
          <h4 style={{ fontWeight: "500", marginTop: "8px" }}>
            Matchweek {week}
          </h4>

          {matches?.map((match) => (
            <div className={style.match} key={match.id}>
              <div className={style["match-details"]}>
                <div className={style["home-row"]}>
                  <div className={style["emblem"]}>
                    <img
                      ...
                      alt=""
                      className={style["Image-fluid"]}
                    />{" "}
                  </div>
                  <h4 className={style["small"]}>{match.homeTeam.name}</h4>
                  <div
                  ...
                  >
                    <strong className={style["small"]}>
                      {match.score.fullTime.home}
                    </strong>
                  </div>
                </div>
                <div className={style["away-row"]}>
                  <div className={style["emblem"]}>
                    <Image
                      width={"25px"} layout={"intrinsic"} height={"40px"}
                  ...
                  <h4 className={style["small"]}>{match.awayTeam.name} </h4>
                  <div
                    className={style["outcome"]}
                    style={
                      match?.score.fullTime.home < match.score.fullTime.away
              ...
              <div className={style["status"]}>
                <p className={style["small"]}>FT</p>
                <p className={style["small"]}>08/05</p>
                <p className={style["small"]}>19:00</p>
              </div>
            </div>
          ))}
        </div>
